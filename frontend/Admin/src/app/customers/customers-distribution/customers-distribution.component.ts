...
@Component({
  selector: 'app-customers-distribution',
  templateUrl: './customers-distribution.component.html',
  styleUrls: ['./customers-distribution.component.css']
})
export class CustomersDistributionComponent implements OnInit {
 ...
 @ViewChild("chart") chart: ChartComponent;
    ...
    this.customerService.getAllCustomers().subscribe({
      next: ((res) => {
        if (res.statusCode === 200) {
          ...
          const coordinates = this.customers.map(customer => ({
  ...
  private getLocationAddress(params: HttpParams): Observable<any> {
    return this.customerService.getLocationDetails(params)
  }

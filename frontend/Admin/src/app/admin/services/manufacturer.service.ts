...
export class ManufacturerService {
  ...
  public deleteManufacturer(manufacturerId: any, accessToken: any): Observable<any>{
    const headers = new HttpHeaders()
      .set('Authorization', `Bearer ${accessToken}`);
    return this.httpClient.delete<any>(`${environment.baseUrl}/api/v1/manufacturers/delete/${manufacturerId}`, { headers: headers })
  }

  public getLocationDetails(params: HttpParams): Observable<any>{
    return this.httpClient.get<any>(`https://api.geocode.earth/v1/reverse`, { params:params });
  }
}
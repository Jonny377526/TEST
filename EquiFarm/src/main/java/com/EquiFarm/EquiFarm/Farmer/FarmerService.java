...
public class FarmerService {
    ...
    public ApiResponse<?> getFarmerProfile() {
        try {
            ...
            log.info("Farmer Profile: {}", farmerOptional.get().getUser().getEmail());
            ...
            if (farmerOptional.isPresent()) {
                ...
                return new ApiResponse<>("Farmer profile not found", null,
    ...
    public ApiResponse<?> updateFarmerProfile(FarmerUserRequest farmerUserRequest, Long id) {
        try {
            ...
            if (farmerOptional.isPresent()) {
                ...
                return new ApiResponse<>("Farmer profile updated successfully.", farmerResponse, HttpStatus.OK.value());
            } else {
                return new ApiResponse<>("Farmer not found", null, HttpStatus.NOT_FOUND.value());
            }
        } catch (Exception e) {
